...
//     return room.id.toString().toLowerCase().includes(query) || room.type.toLowerCase().includes(query);
//   });
...
//                     <Button variant="outline" size="icon" onClick={() => handleViewDetails(room.id.toString())}>
//                       <Eye className="h-4 w-4" />
//                     </Button>
//                     <Button variant="outline" size="icon" onClick={() => handleEditRoom(room.id.toString())}>
...
//           </DialogHeader>
//           <p>Are you sure you want to delete cinema room {roomToDelete?.id}? This action cannot be undone.</p>
//           <DialogFooter>
