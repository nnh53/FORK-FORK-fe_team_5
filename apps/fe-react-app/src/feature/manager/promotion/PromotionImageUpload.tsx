...
export const PromotionImageUpload: React.FC<PromotionImageUploadProps> = ({
  ...
  <div>
    ...
    <div className="flex flex-wrap gap-3">
      {imagePreview ? (
        <img src={imagePreview} alt="Promotion preview" className="w-40 h-40 object-cover rounded" />
      ) : (
        formInitialValues.image && <img src={formInitialValues.image} alt="Promotion" className="w-40 h-40 object-cover rounded" />
      )}
      <input
        ref={fileInputRef}
        id="image"
