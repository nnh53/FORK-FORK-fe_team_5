  ...
  useEffect(() => {
    const getUser = async () => {
      try {
        ...
        user.dob = user?.dob ? user.dob.split('T')[0] : null;
        setFormData(user);
        console.log(user);
      } catch (err) {
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className="flex flex-wrap items-center gap-4 mb-8">
                  <div className="relative min-w-48">
                    {imagePreview ? (
                      ...
                      formData.img && <img src={formData.img} className="w-40 h-40" />
                    )}
                    <input
                      ref={fileInputRef}
                      id="img"
                  ...
                  <button
                    ...
                    type="button"
                    className="btn bg-gray-200 hover:bg-gray-300 text-black border-gray-300 font-semibold"
                  >
                    TẢI ẢNH LÊN
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                  ...
                  <div className="form-control">
                    ...
                    <div className="relative">
                      ...
                      <Field name="phone" type="tel" className="input input-bordered w-full pl-16" />
                    </div>
                  </div>
                  ...
                  <div className="form-control">
                    ...
                    <div className="relative">
                      ...
                      <Field name="dob" type="date" className="input input-bordered w-full pl-16" />
                    </div>
                  </div>
                  ...
                  <div className="form-control">
                    ...
                    <div className="relative">
                      ...
                      <Field as="select" name="gender" className="select select-bordered w-full pl-16">
                  ...
                  <div className="form-control">
                    ...
                    <Field as="select" name="city" className="select select-bordered w-full">
                  ...
                  <div className="form-control">
                    ...
                    <Field as="textarea" name="address" className="block textarea textarea-bordered h-10 w-full" placeholder="Địa chỉ"></Field>
                  </div>
                </div>
                ...
                <div className="mt-8 flex justify-center">
                  <button
                    ...
                    type="submit"
                    className="btn bg-blue-700 hover:bg-blue-800 text-white px-16 text-base font-bold"
                  >
                    CẬP NHẬT
                  </button>
                </div>
